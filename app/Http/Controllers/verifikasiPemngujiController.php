...
class verifikasiPemngujiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $data = Revisi::where('id_penguji', $idPembimbing)->paginate(10);
        return view('page.verifikasi.penguji')->with([
            'data' => $data
        ]);
    }

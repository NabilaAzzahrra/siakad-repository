        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @can('role-M')
                    ...
                    <!-- Navigation Links -->
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-nav-link :href="route('report_presensi_mahasiswa.edit', Auth::user()->email)" :active="request()->routeIs('dashboard')">
                            {{ __('Presensi') }}
                        </x-nav-link>
                    </div>
                ...
                @can('role-O')
                    <!-- Navigation Links -->
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-nav-link :href="route('jadwal_reguler.jadwal_mhs', str_replace('ortu', '', Auth::user()->email))" :active="request()->routeIs('dashboard')">
                            {{ __('Jadwal') }}
                        </x-nav-link>
                    </div>
                ...
                @can('role-D')
                    <!-- Navigation Links -->
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-nav-link :href="route('jadwal_reguler.jadwal_dosen', Auth::user()->email)" :active="request()->routeIs('dashboard')">
                            {{ __('Jadwal') }}
                        </x-nav-link>
                    </div>
                    ...
                    <!-- Navigation Links -->
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-nav-link :href="route('nilai.nilai_dosen', Auth::user()->email)" :active="request()->routeIs('dashboard')">
                            {{ __('Nilai') }}
                        </x-nav-link>
                    </div>
                    ...
                    <!-- Navigation Links -->
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-nav-link :href="route('report_dosen.show_dosen', Auth::user()->email)" :active="request()->routeIs('dashboard')">
                    ...
                    <!-- Navigation Links -->
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-nav-link :href="route('report_keseluruhan.r_mahasiswa')" :active="request()->routeIs('dashboard')">

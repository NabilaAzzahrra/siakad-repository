            ...
            $('#sesi-datatable').DataTable({
                ...
                columns: [{
                    ...
                    render: (data) => {
                        ...
                        let deleteUrl =
                            `<button onclick="return sesiDelete('${data.id}','${data.sesi}')" class="bg-red-500 hover:bg-bg-red-300 px-3 py-1 rounded-md text-xs text-white"><i class="fas fa-trash"></i></button>`;

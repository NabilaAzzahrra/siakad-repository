    ...
    <x-slot name="header">
        <p class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <div class="flex items-center font-bold">Master<i class="fi fi-rr-caret-right mt-1"></i> Jadwal<i
                    class="fi fi-rr-caret-right mt-1"></i> <span class="text-amber-100">Sesi</span></div>
        </p>
    </x-slot>
                ...
                <div class="w-full md:w-3/12 p-3">
                    <div class="bg-white w-full dark:bg-gray-800 overflow-hidden shadow-xl border border-gray-200 rounded-3xl">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <form action="{{ route('sesi.store') }}" method="post" id="sesiForm">
                                @csrf
                                <div class="p-4 rounded-xl">
                                    <div class="mb-5">
                                        <label for="sesi"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sesi <span class="text-red-500">*</span></label>
                                        <input type="text" id="sesi" name="sesi"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Masukan Nama sesi disini ..." />
                                        <p id="error-sesi" class="mt-2 text-sm text-red-500 hidden">Sesi wajib diisi.
                                        </p>
                                    </div>
                                    <div class="mb-5">
                                        <label for="pukul"
                                        ...
                                        <select class="js-example-placeholder-single js-states form-control w-full m-6"
                                            name="id_pukul" id="pukul" data-placeholder="Pilih Pukul">
                        ...
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <div class="flex justify-center">
                                <div class="p-12" style="width:100%;  overflow-x:auto;">
                                    <table class="table table-bordered" id="sesi-datatable">
                                        <thead>
                                            <tr>
                                                <th class="w-7">No.</th>
                                                <th>sesi</th>
            ...
            <div class="w-full md:w-1/4 relative bg-white rounded-lg shadow mx-5">
                ...
                <form method="POST" id="formSourceModal">
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        ...
                        <div class="">
                            <label for="text" class="block mb-2 text-sm font-medium text-gray-900">Sesi <span class="text-red-500">*</span></label>
                        ...
                        <div class="">
                            ...
                            <select class="js-example-placeholder-single js-states form-control w-[450px] m-6"
                                id="id_pukul" name="id_pukull" data-placeholder="Pilih Pukul">
                                <option value="">Pilih...</option>
                                @foreach ($pukul as $p)
                                    <option value="{{ $p->id }}">{{ $p->pukul }}</option>
                                @endforeach
    ...
    <script>
            ...
            $('#sesi-datatable').DataTable({
                ...
                columns: [{
                    ...
                    render: (data) => {
                        ...
                        let deleteUrl =
                            `<button onclick="return sesiDelete('${data.id}','${data.sesi}')" class="border-2 border-dashed border-red-500 text-red-500 hover:bg-red-100 px-3 py-1 rounded-xl h-10 w-10 text-xs"><i class="fas fa-trash"></i></button>`;
        ...
        const sesiDelete = async (id, sesi) => {
            Swal.fire({
                ...
                text: `Data sesi ${sesi} akan dihapus secara permanen!`,
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    await axios.post(`/sesi/${id}`, {
                        ...
                        .then(function(response) {
                            Swal.fire({
                                title: 'Terhapus!',
                                text: `Data sesi ${sesi} berhasil dihapus.`,
                                icon: 'success',

            ...
            <div class="w-full p-3">
                <div
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <form action="{{ route('jadwal_reguler.update', $jadwal->id_jadwal) }}" method="post">
                            @csrf
                            @method('PATCH')
                                    ...
                                    <div class="flex gap-5 w-full">
                                        ...
                                        <div class="lg:mb-5 w-full">
                                            ...
                                            <input type="text" id="pukul" name="pukul"
                                                ...
                                                placeholder="Masukan Pukul disini ..." value="{{ $jadwal->pukul }}"
                                                readonly />
                                        </div>
                                        <div class="lg:mb-5 w-full">
                                            <label for="pukul"
                                            ...
                                            <select
                                                ...
                                                <option value="{{ $jadwal->id_sesi2 }}">{{ $jadwal->sesi2 }}</option>
                                                @foreach ($sesi as $k)
                                        ...
                                        <div class="lg:mb-5 w-full">
                                            ...
                                            <input type="text" id="pukul_dua" name="pukul_dua"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Masukan Pukul disini ..." value="{{ $jadwal->pukul2 }}"
                                                readonly />
                                        </div>
                                        <div class="lg:mb-5 w-full">
                                            <label for="kurikulum"
                                        ...
                                        <div class="mb-5 w-full">
                                            ...
                                            <input type="text" id="semester" name="semester"
                                                ...
                                                value="{{ $jadwal->semester }}" readonly />
                                        </div>
                                        <div class="mb-5 w-full">
                                            <label for="sks"
                                            ...
                                            <input type="text" id="sks" name="sks"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Masukan SKS disini ..." value="{{ $jadwal->sks }}"
                                                readonly />
                                        </div>
                                    </div>
                                </div>

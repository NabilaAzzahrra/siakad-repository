<x-app-layout>
    <x-slot name="header">
        <p class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <div class="flex items-center font-bold">Master<i class="fi fi-rr-caret-right mt-1"></i> Jadwal<i
                    class="fi fi-rr-caret-right mt-1"></i> <span class="text-amber-100">Keterangan</span></div>
        </p>
    </x-slot>
                                ...
                                <div class="p-4 rounded-xl">
                                    <div class="mb-5">
                                        <label for="keterangan"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Keterangan <span class="text-red-500">*</span></label>
                                        <input type="text" id="keterangan" name="keterangan"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Masukan keterangan disini ..." oninput="this.value = this.value.toUpperCase();"/>
            ...
            <div class="w-full md:w-1/4 relative bg-white rounded-lg shadow mx-5">
                ...
                <form method="POST" id="formSourceModal">
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        ...
                        <div class="mb-5">
                            <label for="text"
                                class="block mb-2 text-sm font-medium text-gray-900">Keterangan <span class="text-red-500">*</span></label>
                            <input type="text" id="keterangans" name="keterangan"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                id="" placeholder="Masukan keterangan disini..." oninput="this.value = this.value.toUpperCase();">
                        </div>
                    </div>
    ...
    <script>
                    ...
                    render: (data) => {
                        let editUrl =
                            `<button type="button" data-id="${data.id}"
                                                        data-modal-target="sourceModal" data-keterangan="${data.keterangan}"
                        ...
                        let deleteUrl =
                            `<button onclick="return keteranganDelete('${data.id}','${data.keterangan}')" class="border-2 border-dashed border-red-500 text-red-500 hover:bg-red-100 px-3 py-1 rounded-xl h-10 w-10 text-xs"><i class="fas fa-trash"></i></button>`;
        ...
        const editSourceModal = (button) => {
            ...
            document.getElementById('title_source').innerText = `Update keterangan ${keterangan}`;
            document.getElementById('keterangans').value = keterangan;

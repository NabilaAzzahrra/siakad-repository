            ...
            $('#keterangan-datatable').DataTable({
                ...
                columns: [{
                    ...
                    render: (data) => {
                        ...
                        let deleteUrl =
                            `<button onclick="return keteranganDelete('${data.id}','${data.keterangan}')" class="bg-red-500 hover:bg-bg-red-300 px-3 py-1 rounded-xl h-10 w-10 text-xs text-white"><i class="fas fa-trash"></i></button>`;

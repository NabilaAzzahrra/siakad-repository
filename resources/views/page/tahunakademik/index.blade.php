<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <div class="flex items-center">Master<i class="fi fi-rr-caret-right mt-1"></i> Jadwal<i class="fi fi-rr-caret-right mt-1"></i> <span class="text-red-500">Tahun Akademik</span></div>        </h2>
    </x-slot>
            ...
            <div class="w-full md:w-1/2 relative bg-white rounded-lg shadow mx-5">
                ...
                <form method="POST" id="formSourceModal">
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        ...
                        <div>
                            <label for="text" class="block mb-2 text-sm font-medium text-gray-900">Tahun Akademik</label>
            ...
            $('#tahunakademik-datatable').DataTable({
                ...
                columns: [{
                    ...
                    render: (data) => {
                        ...
                        let deleteUrl =
                            `<button onclick="return tahunakademikDelete('${data.id}','${data.tahunakademik}')" class="bg-red-500 hover:bg-bg-red-300 px-3 py-1 rounded-xl h-10 w-10 text-xs text-white"><i class="fas fa-trash"></i></button>`;

                            ...
                            <div class="">
                                <div class="flex flex-col lg:flex-row items-center justify-between">
                                    ...
                                    <div class="flex gap-4 mb-2">
                                        <div class="mt-4">
                                            <a href="{{ route('jadwal_reguler.print_jadwal_dosen', Auth::user()->email) }}" target="_blank"
                                ...
                                <div class="pt-6 w-full" style="width:100%;overflow-x:auto;">
                                    <div class="flex flex-col sm:flex-row justify-between items-center mb-4">
                                        <div class="md:mt-0 sm:flex sm:space-x-4 w-full">
                                            <!-- Form untuk entries -->
                                            <x-show-entries :route="route('jadwal_reguler.jadwal_dosen', Auth::user()->email)" :search="request()->search">
                                            </x-show-entries>
                                        </div>

                                        <div class="sm:ml-16 sm:mt-0 sm:flex sm:space-x-4 sm:flex-none">
                                            <form action="{{ route('jadwal_reguler.jadwal_dosen', Auth::user()->email) }}" method="GET"
                                                    ...
                                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                        ...
                                                        <td class="px-6 py-4 text-center">
                                                            <a href="{{ route('jadwal_reguler.show', $j->kode_jadwal) }}"
                                                                class="mr-2 border border-green-500 hover:bg-green-100 px-4 py-3 rounded-xl text-xs text-green-500">

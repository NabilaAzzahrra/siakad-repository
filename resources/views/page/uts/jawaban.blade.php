                            ...
                            <div
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td class="text-wrap">{{ $uts->jadwal->detail_kurikulum->materi_ajar->materi_ajar }}</td>
                                    </tr>
                                    <tr>
                                        <td class="pr-2 pt-2"><i class="fi fi-sr-calendar-clock"></i></td>
                                        <td class="font-bold">Semester/SKS</td>
                                        <td class="pl-2 pr-2">:</td>
                                        <td>{{ $uts->jadwal->detail_kurikulum->materi_ajar->semester->semester }} /
                                            {{ $uts->jadwal->detail_kurikulum->materi_ajar->sks }}</td>
                                    </tr>
                                    <tr>
                                        <td class="pr-2 pt-2"><i class="fi fi-sr-chalkboard-user"></i></td>
                                        <td class="font-bold">Pengajar</td>
                                        <td class="pl-2 pr-2">:</td>
                                        <td class="text-wrap">{{ $uts->jadwal->dosen->nama_dosen }}</td>
                                    </tr>
                                    <tr>
                                        <td class="pr-2 pt-2"><i class="fi fi-sr-hourglass-start"></i></td>
                                        <td class="font-bold">Tanggal UTS</td>
                                        <td class="pl-2 pr-2">:</td>
                                        <td>{{ date('d-m-Y', strtotime($uts->tgl_ujian)) }}</td>
                                    </tr>
                                    <tr>
                                        <td class="pr-2 pt-2"><i class="fi fi-sr-hourglass-start"></i></td>
                                        <td class="font-bold">Waktu</td>
                                        <td class="pl-2 pr-2">:</td>
                                        <td>{{ date($uts->waktu_ujian) }} WIB</td>
                                    </tr>
                                </table>
                            </div>
                            <div

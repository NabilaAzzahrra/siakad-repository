<x-app-layout>
                            ...
                            <div class="">
                                <div class="flex flex-col lg:flex-row items-center justify-between">
                                    ...
                                    <div class="flex gap-4 mb-2">
                                        ...
                                        <div class="mt-4">
                                            <a href="{{ route('ujian_uas.daftar_print_uas') }}" target="_blank"
                                ...
                                <div class="pt-3 w-full" style="width:100%;overflow-x:auto;">
                                    <div class="flex flex-col sm:flex-row justify-between items-center mb-4">
                                        <div class="md:mt-0 sm:flex sm:space-x-4 w-full">
                                            <!-- Form untuk entries -->
                                            <x-show-entries :route="route('ujian_uas.index')" :search="request()->search">
                                            </x-show-entries>
                                        </div>

                                        <div class="sm:ml-16 sm:mt-0 sm:flex sm:space-x-4 sm:flex-none">
                                            <form action="{{ route('ujian_uas.index') }}" method="GET"
    ...
    <div id="modal-filter" class="hidden fixed inset-0 flex justify-center items-center z-50">
        ...
        <div class="bg-white rounded-lg p-6 lg:w-4/12 w-full shadow-xl z-10">
            <h2 class="text-lg font-bold mb-4 bg-amber-50 pl-6 pr-6 p-2 rounded-xl">Filter UAS Per
                Tahun Akademik</h2>
            <form id="filterForm" action="{{ route('ujian_uas.index') }}" method="get" class="w-full">

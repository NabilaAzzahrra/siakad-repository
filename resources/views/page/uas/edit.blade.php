                                    ...
                                    <div class="flex flex-col lg:flex-row lg:gap-5">
                                        <div class="mb-5 w-full">
                                            ...
                                            <input type="text" id="materi_ajar" name="materi_ajar"
                                                ...
                                                value="{{ $uas->jadwal->detail_kurikulum->materi_ajar->materi_ajar }}" readonly/>
                                        </div>
                                        <div class="mb-5 w-full">
                                            <label for="sks"
                                            ...
                                            <input type="text" id="sks" name="sks"
                                                class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Masukan Materi Ajar disini ..."
                                                value="{{ $uas->jadwal->detail_kurikulum->materi_ajar->sks }}" readonly/>
                                        </div>
                                        <div class="mb-5 w-full">
                                            <label for="semester"
                                            ...
                                            <input type="text" id="semester" name="semester"
                                                class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Masukan Materi Ajar disini ..."
                                                value="{{ $uas->jadwal->detail_kurikulum->materi_ajar->semester->semester }}" readonly/>
                                        </div>
                                        <div class="mb-5 w-full">
                                            ...
                                            <input type="text" id="nama_dosen" name="nama_dosen"
                                                class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Masukan Materi Ajar disini ..."
                                                value="{{ $uas->jadwal->dosen->nama_dosen }}" readonly/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-col lg:flex-row lg: gap-5">
                                        <div class="mb-5 w-full">
                                            ...
                                            <input type="text" id="materi_ajar" name="materi_ajar"
                                                class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Masukan Materi Ajar disini ..."
                                                value="{{ $uas->jadwal->ruang->ruang }}" readonly/>
                                        </div>
                                    ...
                                    <div class="flex flex-col lg:flex-row gap-5">
                                        <div class="mb-5 w-full">
                                            ...
                                            <input type="text" id="file_sebelumnya" name="file_sebelumnya"
                                                class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Masukan Materi Ajar disini ..." value="{{ $uas->file }}" readonly/>
                                        </div>
                                        <div class="mb-5 w-full">
                                            ...
                                            <input type="text" id="file_cadangan_sebelumnya" name="file_cadangan_sebelumnya"
                                                class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Masukan Materi Ajar disini ..." value="{{ $uas->file_cadangan }}" readonly/>
                                        </div>
                                    </div>
                                    <div class="flex flex-col lg:flex-row gap-5">
                                        <div class="mb-5 w-full">

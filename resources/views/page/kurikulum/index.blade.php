            ...
            $('#kurikulum-datatable').DataTable({
                ...
                columns: [{
                    ...
                    render: (data) => {
                        ...
                        let detailUrl = `<a href=${UrlEbook} class="bg-emerald-500 hover:bg-emerald-600 px-3 py-1 rounded-md text-xs text-white"><i class="fas fa-eye"></i></a>`;
                        let editUrl =
                        ...
                        return `<div style="text-align:center">${detailUrl} ${editUrl} ${deleteUrl}</div>`;
                    }
                }, ],
            });
        });

<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <div class="flex items-center">Report<i class="fi fi-rr-caret-right mt-1"></i> Nilai <i class="fi fi-rr-caret-right mt-1"></i> Mahasiswa <i class="fi fi-rr-caret-right mt-1"></i> <span class="text-red-500">Report Nilai Mahasiswa</span></div>
        </h2>
    </x-slot>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($mahasiswa_lengkap as $m)
                                                        <tr
                                                            ...
                                                            <td class="px-6 py-4 ">
                                                                <a href="{{ route('report_nilai_mahasiswa.edit', $m->nim) }}"

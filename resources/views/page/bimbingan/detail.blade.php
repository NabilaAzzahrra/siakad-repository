            ...
            <div class="flex flex-col md:flex-row justify-center">
                ...
                <div class="w-full md:w-full p-3">
                    ...
                    <div class="bg-white w-full dark:bg-gray-800 overflow-hidden shadow-lg rounded-3xl">
                        ...
                        <div class="relative overflow-x-auto rounded-lg px-12 pt-4 pb-12 flex gap-5 justify-between">
                            <div class="bg-amber-50 p-4 w-full rounded-2xl text-center">
                                Jumlah Bimbingan : <span class="bg-emerald-100 p-2 rounded-xl font-bold">{{ count($data) }}</span>
                            </div>
                        </div>
                    </div>
                </div>

<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <div class="flex items-center">Report<i class="fi fi-rr-caret-right mt-1"></i> Nilai <i class="fi fi-rr-caret-right mt-1"></i> <span class="text-red-500">KHS</span></div>
        </h2>
    </x-slot>
                ...
                <div class="w-full md:w-full p-3">
                    <div class="bg-white w-full dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <form action="">
                                <div class="lg:mt-12 lg:mx-12 mt-4 flex flex-col lg:flex-row gap-5">
                                    <div class="w-full">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <select
                                            class="js-example-placeholder-single js-states form-control w-[930px] m-6"
                                            id="semester" name="semester" data-placeholder="Pilih Semester">
                                            <option value="">Pilih...</option>

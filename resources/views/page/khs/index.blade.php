<x-app-layout>
    ...
    <div id="modal-filter" class="hidden fixed inset-0 flex justify-center items-center z-50">
        ...
        <div class="bg-white rounded-lg p-6 lg:w-4/12 w-full shadow-xl z-10">
            ...
            <form id="filterForm" action="{{ route('khs.index') }}" method="get" class="w-full">
        ...
        function filter() {
            ...
            modalContent.innerHTML = `
                <div class="flex flex-col w-full gap-4">
                    ...
                    <select class="js-example-placeholder-single js-states form-control w-full" id="semester" name="semester" data-placeholder="Pilih Semester">
                        <option value="">Pilih...</option>
                        @foreach ($semester as $p)
                            <option value="{{ $p->semester }}">{{ $p->semester }}</option>
                        @endforeach
                    </select>

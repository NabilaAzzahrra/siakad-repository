                                        ...
                                        <div class="flex flex-col lg:flex-row gap-5">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <input type="text" id="materi_sebelumnya" name="materi_sebelumnya"
                                                    class="w-full border-0 border-b-2 border-gray-300 focus:border-black focus:ring-0"
                                                    placeholder="Masukkan Judul Materi disini"
                                                    value="{{ $presensi->file_materi }}" readonly>
                                            </div>
                                            <div class="w-full">
                                                <label for="file"
                                            ...
                                            <div class="flex flex-col lg:flex-row gap-5">
                                                ...
                                                <div class="w-full">
                                                    <select
                                                        ...
                                                        <option value="HADIR"
                                                            {{ $pr->keterangan == 'HADIR' ? 'selected' : '' }}>HADIR
                                                        </option>
                                                        <option value="SAKIT"
                                                            {{ $pr->keterangan == 'SAKIT' ? 'selected' : '' }}>SAKIT
                                                        </option>
                                                        <option value="IZIN"
                                                            {{ $pr->keterangan == 'IZIN' ? 'selected' : '' }}>IZIN
                                                        </option>
                                                        <option value="ALPA"
                                                            {{ $pr->keterangan == 'ALPA' ? 'selected' : '' }}>ALPA
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>

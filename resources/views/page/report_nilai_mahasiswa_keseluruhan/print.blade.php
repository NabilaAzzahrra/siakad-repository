...
<body>
    ...
    <div class="book">
        <div class="page" id="result">
            ...
            <div class="absolute top-[200px] ml-16 left-0 right-0 text-center text-sm font-bold">
            ...
            <div class="absolute top-[280px] ml-[6px] mr-[90px] left-0 right-0 text-center text-sm ">

<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex items-center font-bold">Report<i class="fi fi-rr-caret-right mt-1"></i> <span>Nilai</span><i class="fi fi-rr-caret-right mt-1"></i> <span>Mahasiswa</span><i class="fi fi-rr-caret-right mt-1"></i> <span
                class="text-amber-100">Keseluruhan</span></div>
        </p>
    </x-slot>
                            ...
                            <div class="pt-3 w-full" style="width:100%;overflow-x:auto;">
                                <div class="flex flex-col sm:flex-row justify-between items-center mb-4">
                                    <div class="md:mt-0 sm:flex sm:space-x-4 w-full">
                                        <!-- Form untuk entries -->
                                        <x-show-entries :route="route('report_nilai_keseluruhan.index')" :search="request()->search">
                                        </x-show-entries>
                                    </div>
                                    <div class="sm:ml-16 sm:mt-0 sm:flex sm:space-x-4 sm:flex-none">
                                        <form action="{{ route('report_nilai_keseluruhan.index') }}" method="GET"
                                        ...
                                        <tbody id="jadwalRegulerTable">
                                            ...
                                            @forelse($jadwal as $key => $m)
                                                ...
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    ...
                                                    <td class="px-6 py-4 text-center">
                                                        <a href="{{ route('report_nilai_keseluruhan.show', $m->kode_jadwal) }}"

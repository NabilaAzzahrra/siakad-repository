<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold lg:text-xl text-gray-800 dark:text-gray-200 leading-tight flex text-md text-wrap">
            <div class="flex items-center">Report<i class="fi fi-rr-caret-right mt-1"></i> Presensi <i class="fi fi-rr-caret-right mt-1"></i> Mahasiswa <i class="fi fi-rr-caret-right mt-1"></i> <span class="text-red-500">Keseluruhan</span></div>
        </h2>
    </x-slot>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($jadwal as $m)
                                                        <tr
                                                            ...
                                                            <td class="px-6 py-4 ">
                                                                <a href="{{ route('report_keseluruhan.edit', $m->id_jadwal) }}"

<x-app-layout>
    ...
    <div id="modal-filter" class="hidden fixed inset-0 flex justify-center items-center z-50">
        ...
        <div class="bg-white rounded-lg p-6 lg:w-4/12 w-full shadow-xl z-10">
            <h2 class="text-lg font-bold mb-4 bg-amber-50 pl-6 pr-6 p-2 rounded-xl">Filter Nilai Pembelajaran Per
                Tahun Akademik</h2>
            <form id="filterForm" action="{{ route('nilai.index') }}" method="get" class="w-full">
